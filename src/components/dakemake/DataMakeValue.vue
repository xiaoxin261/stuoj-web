...
const getFromProps = () => {
    min.value = props.value.min ?? props.value.min_id ?? 0;
    minIdFlag.value = props.value.min === undefined;
    max.value = props.value.max ?? props.value.max_id ?? 0;
    maxIdFlag.value = props.value.max === undefined;
    typeFlag.value = props.value.type === Type.Int;
};
